...
public class PatientController {
    ...
    public PatientController(PatientService patientService,
                             ...
                             TreatmentPlanService treatmentPlanService, ReminderRescheduleService reminderRescheduleService) {
    ...
    public String saveRoutine(@RequestParam(value = "breakfastTime", required = false)
        ...
        reminderRescheduleService.rescheduleFutureMedicationReminders(userId, routine);
        return "redirect:/patient/profile";
    }
