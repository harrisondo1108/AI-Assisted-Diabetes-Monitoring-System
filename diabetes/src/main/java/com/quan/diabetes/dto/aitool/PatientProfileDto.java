...
public record PatientProfileDto(
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("Giới tính (true=Nam, false=Nữ)") Boolean gender,
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("Lịch sử bệnh án") String permanentMedicalHistory,
