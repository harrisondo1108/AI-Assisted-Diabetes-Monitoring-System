...
@Service
public class ReminderContentService {

    public static final String MEDICATION_REMINDER_TITLE = "Nhắc nhở lịch sử dụng thuốc";

    @Autowired
    private GroupReminderService groupReminderService;
    ...
    public void generateReminder(String clinicalExamId) {
        ...
        for (MedicationTiming timing : timings) {
            ...
            for (int i = 0; i < dateList.size() - 1; i++) {
                ...
                String segmentReminder = groupReminderService.generateGroupReminder(name, time, reminderForDate);
